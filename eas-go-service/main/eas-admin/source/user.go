...
var admins = []model2.User{
	{EASBase: model2.EASBase{ID: 1, CreateTime: time.Now(), UpdateTime: time.Now()}, UUID: uuid.NewV4(), Username: "admin", Password: "e10adc3949ba59abbe56e057f20f883e", Nickname: "超级管理员", HeaderImg: "https://imageserver.eveonline.com/Character/2115581995_1024.jpg", RoleId: "2115581995"},
}
